...
router.register(r'listaCliente',ClienteViewSet,basename='ListaClientes')
router.register(r'listaCompras',CompraViewSet,basename='ListaCompras')
router.register(r'listaProduto',ProdutoViewSet,basename='ListaProduto')
